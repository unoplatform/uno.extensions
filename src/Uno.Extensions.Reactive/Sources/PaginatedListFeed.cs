...
//		public MessageManager<T> Messages { get; set; }
//	}

//	public class AsyncContext<TArg, TResult>
//	{
//		public SourceContext SourceContext { get; }

//		public MessageManager<TArg, TResult> Messages { get; set; }
//	}

//	async ValueTask Load(AsyncContext<IImmutableList<TItem>> context, TokenSet<RefreshToken>? refresh, CancellationToken ct)
//	{
...
//				context.Messages.BeginUpdate(ct, preservePendingAxes: MessageAxis.Progress),
//				cursor!,
//				refresh,
//				pageInfo with { Tokens = PageToken.Initial(this, context.SourceContext) },
...
//			// Prepare the next token that we will process
