...
public static class ViewRegistryExtensions
{
	...
	{
		return registry.Items.FindByInheritedTypes(viewModelType, map => map.ViewModel);
	}
	...
	{
		return registry.Items.FindByInheritedTypes(viewType, map => map.View);
	}
	...
	{
		return registry.Items.FindByInheritedTypes(dataType, map => map.Data?.Data);
	}
	...
	{
		return registry.Items.FindByInheritedTypes(dataType, map => map.ResultData);
	}
}
