...
public static class NavigatorExtensions
{
	...
	public static async Task<TResult?> GetDataAsync<TResult>(this INavigator navigator, object sender, string qualifier = Qualifiers.None, CancellationToken cancellation = default)
	{
		var result = await navigator.NavigateForResultAsync<TResult>(sender, qualifier, cancellation: cancellation).AsResult();
		return result.SomeOrDefault();
	}

	public static async Task<TResult?> GetDataAsync<TResult>(this INavigator navigator, object sender, string route, string qualifier = Qualifiers.None, CancellationToken cancellation = default)
	{
		var result = await navigator.NavigateRouteForResultAsync<TResult>(sender, route, qualifier, cancellation: cancellation).AsResult();
		return result.SomeOrDefault();
	}

	public static async Task<TResult?> GetDataAsync<TViewModel, TResult>(this INavigator navigator, object sender, string qualifier = Qualifiers.None, CancellationToken cancellation = default)
	{
		var result = await navigator.NavigateViewModelForResultAsync<TViewModel, TResult>(sender, qualifier, cancellation: cancellation).AsResult();
		return result.SomeOrDefault();
	}
