...
public class SystemTextJsonSerializer : ISerializer
{
	...
	public SystemTextJsonSerializer(IServiceProvider services, JsonSerializerOptions? serializerOptions = null)
	{
		...
		_serializerOptions = services.GetService<IOptions<JsonSerializationOptions>>()?.Value?.SerializerOptions ??
			serializerOptions ??
	...
	private static Exception CreateInvalidOperationException(Type targetType)
		=> new InvalidOperationException("Reflection-based serialization has been disabled for this application. " +
			$"Use the IServiceCollection.{nameof(ServiceCollectionExtensions.AddJsonSerializationTypeInfoResolvers)}() or IHostBuilder.{nameof(HostBuilderExtensions.UseJsonSerializationResolvers)}() extension methods to enable JSON deserialization " +
	...
	///   Use <see cref="ServiceCollectionExtensions.AddJsonSerializationTypeInfoResolvers" /> to add support.
	/// </exception>
