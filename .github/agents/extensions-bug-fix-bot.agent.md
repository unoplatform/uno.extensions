...
- **Keep your commit messages compliant to Conventional Commits**: Make sure all of your commits follow the guidelines of Conventional Commits detailed here: https://www.conventionalcommits.org/en/v1.0.0/#specification
